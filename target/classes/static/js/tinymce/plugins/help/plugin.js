...
define(
  ...
  function (StrAppend, StringParts, Error) {
    ...
    /** Given a string and object, perform templates-replacements on the string, as specified by the object.
     * Any templates fields of the form ${name} are replaced by the string or number specified as obj["name"]
     * Based on Douglas Crockford's 'supplant' method for templates-replace of strings. Uses different templates format.
     */
